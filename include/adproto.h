...
#define ADP_VERSION_0_7		0.7

/* Most current protocol version. */
#define ADP_CURRENT_VERSION	ADP_VERSION_0_7
...
/* Features since protocol version 0.6 */
#define ADP_FEATVER_NEEDRESTART	ADP_VERSION_0_7
...
#define ADP_STRLEN_NRVERSION	255
#define ADP_PATTERN_NRVERSION	"NEEDRESTART-VER: %"ADP_QUOTE(ADP_STRLEN_NRVERSION)"s"

#define ADP_STRLEN_NRKCURRENT	255
#define ADP_PATTERN_NRKCURRENT	"NEEDRESTART-KCUR: %"ADP_QUOTE(ADP_STRLEN_NRKCURRENT)"s"

#define ADP_STRLEN_NRKEXPECTED	255
#define ADP_PATTERN_NRKEXPECTED	"NEEDRESTART-KEXP: %"ADP_QUOTE(ADP_STRLEN_NRKEXPECTED)"s"

#define ADP_PATTERN_NRKSTATUS	"NEEDRESTART-KSTA: %d"

#define ADP_STRLEN_NRSERVICE	255
#define ADP_PATTERN_NRSERVICE	"NEEDRESTART-SVC: %"ADP_QUOTE(ADP_STRLEN_NRSERVICE)"s"
