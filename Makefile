...
BIN = apt-dater
OBJ = apt-dater.o keyfiles.o ui.o stats.o exec.o screen.o colors.o lock.o
SRC = apt-dater.c keyfiles.c ui.c stats.c exec.c screen.c apt-dater.h extern.h ui.h screen.h colors.h
